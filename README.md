...
## MVP
Your MVP is to create an application that addresses the following user stories: 
* As a user, I should see a list of all items that I need to pack.
* As a user, I should be able to add a new item to my packing list.
* As a user, I should see my newly added item in my packing list. 
